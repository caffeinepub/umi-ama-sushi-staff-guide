    ...
    <div className="w-full max-w-5xl mx-auto px-4 pb-16">
      ...
      >
        ...
        <p className="font-sans text-muted-foreground text-base leading-relaxed max-w-xl">
          Explore each section of the AMA Sushi menu — ingredients, dietary
          information, beverage pairings, and the service notes that elevate
          every dish.
        </p>
      </motion.div>
                  ...
                  {item.dietary.length > 0 && (
                    <div className="mb-4">
                      ...
                      <p className="font-sans text-xs text-muted-foreground mt-2">
                        <span className="font-medium">CBR</span> = Contains, But
                        Removable — can be omitted upon guest request.
                      </p>
                    </div>
                  )}
